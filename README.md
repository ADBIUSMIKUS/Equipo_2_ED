# Ejercicios del Equipo 2

Aplicación de escritorio en C# y Windows Forms que reúne todos los ejercicios en un único menú de estilo retro.
...
- **Máximo común divisor:** permite calcular el MCD mediante Euclides, resta sucesiva, lista de divisores o factorización prima, mostrando el procedimiento paso a paso.
...
Descarga [`Ejecutable/Ejercicios_Equipo_2.exe`](Ejecutable/Ejercicios_Equipo_2.exe) y ábrelo en Windows de 64 bits. Es el ejecutable unificado y autónomo: no necesitas instalar .NET por separado. Usa la opción **Download raw file** de GitHub para descargar el archivo, en lugar de abrir su vista previa.
